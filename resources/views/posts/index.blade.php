                        ...
                        @foreach ($posts as $post)
                            <article class="flex max-w-xl flex-col items-start justify-between border-solid border-2 border-neutral-200 rounded-md bg-neutral-100">
                                ...
                                <div class="relative flex items-center mx-4 my-4">
                                    <a href="#" class="mr-2 rounded-md bg-amber-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600">
                                        Read more
                                    </a>
                                    <div class="text-sm/6">
