        ...
        <div class="bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="group relative flex items-center mx-4 my-4 border-t border-neutral-200">
                    <form action="{{ route('posts.edit.post', ['id' => $post->id]) }}" method="POST" class="w-full mt-4 px-4 py-4 border-solid border-0 border-neutral-200 rounded-md bg-neutral-100">
                        @csrf
                        <div>
